...
public record WindowSevenState
{
...
public class WindowSevenViewModel : IDisposable
{
    private readonly CompositeDisposable _disposables = new();
    private readonly ISnackService _snackService;

    // --- State
    private readonly BehaviorSubject<WindowSevenState> _stateSubject = new(new WindowSevenState());
    private IObservable<WindowSevenState> StateObs => _stateSubject.AsObservable();
